...
const CategoriesPage = () => {
  ...
  return (
    <div className="p-12 mb-4 md:py-0 max-w-7xl mx-auto font-serif">
      <h1 className="text-4xl text-center font-bold mb-8 text-white glow-text" data-aos= "fade-right">
...
//         {categories.map((category, index) => (
//           <Link href={`/category/${category.name}`} key={index} className="relative block">
//             <Image
//               src={category.image}
//               alt={category.name}
//               width={500}
